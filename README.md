...
| [amp](tools/amp/) | tool | `enclave --tool amp` — Sourcegraph's Amp CLI, installed checksum-verified from upstream storage, with its self-updater and its remote-control paths cut off |
